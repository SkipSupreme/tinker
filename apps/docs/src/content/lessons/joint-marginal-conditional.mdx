...
<StepCheck
  id="joint-marginal-conditional#marginal-of-X-eq-1"
  title="Marginal of X"
  prompt="P(X = 1) = "
  answer={0.5}
  tolerance={0.001}
...
<StepCheck
  id="joint-marginal-conditional#conditional-Y-given-X-eq-1"
...
<StepCheck
  id="joint-marginal-conditional#bigram-chain-rule-score"
...
<StepCheck
  id="joint-marginal-conditional#bayes-rare-disease-posterior"
