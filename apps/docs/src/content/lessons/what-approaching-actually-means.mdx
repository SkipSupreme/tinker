...
<StepCheck
  id="what-approaching-actually-means#limit-of-x2-minus-4-over-x-minus-2"
...
<StepCheck
  id="what-approaching-actually-means#sin-1-over-x-does-not-exist"
...
<StepCheck
  id="what-approaching-actually-means#continuous-plug-in-e-over-4"
