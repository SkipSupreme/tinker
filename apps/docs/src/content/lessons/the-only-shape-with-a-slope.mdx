...
<StepCheck
  id="the-only-shape-with-a-slope#slope-through-1-2-and-5-14"
  title="Rise over run"
  prompt="slope = "
  answer={3}
...
<StepCheck
  id="the-only-shape-with-a-slope#y-intercept-slope-neg-2-point-3-neg-1"
...
<StepCheck
  id="the-only-shape-with-a-slope#perpendicular-of-quarter-slope"
