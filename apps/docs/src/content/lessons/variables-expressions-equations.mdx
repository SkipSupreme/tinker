...
<StepCheck
  id="variables-expressions-equations#substitute-a-2-b-neg-3-c-10"
...
<StepCheck
  id="variables-expressions-equations#solve-5x-minus-4-equals-21"
  title="Solve it"
  prompt="x = "
  answer={5}
...
<StepCheck
  id="variables-expressions-equations#solve-neg-2x-plus-9-equals-3"
