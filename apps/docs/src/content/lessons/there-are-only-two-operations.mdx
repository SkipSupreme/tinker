...
<StepCheck
  id="there-are-only-two-operations#walk-neg-7-minus-neg-3-plus-neg-4"
  title="Walk it out"
  prompt="lands at "
  answer={-8}
...
<StepCheck
  id="there-are-only-two-operations#product-three-negatives"
...
<StepCheck
  id="there-are-only-two-operations#twelve-divided-by-neg-four"
