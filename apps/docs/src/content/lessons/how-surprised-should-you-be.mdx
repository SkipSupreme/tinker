...
<StepCheck
  id="how-surprised-should-you-be#info-content-1-in-8"
...
<StepCheck
  id="how-surprised-should-you-be#three-bits-to-nats"
...
<StepCheck
  id="how-surprised-should-you-be#entropy-one-hot-zero"
...
<StepCheck
  id="how-surprised-should-you-be#entropy-uniform-on-32"
  title="Uniform on 32"
  prompt="H = "
  answer={5}
  tolerance={0.01}
